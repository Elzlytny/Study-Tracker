...
1. Clone the repository:
   ...
   cd study-tracker
   ```
2. Open `index.html` directly in your browser, **or** run it with a local server (recommended, for relative paths and dev tools to work smoothly):
   ```bash
   npx serve .
   ```
...
This project was developed for academic purposes as part of a university course. Feel free to fork and build on it for learning purposes.
